 ...
 */
public abstract class BaseSettingsDialogActivity extends AppCompatActivity {
    ...
    private void updateTitle() {
        // don't work because of FEATURE_NO_TITLE?
        ...
        protected void changeScreen(@StringRes int id, final Class<?> cls) {
            ...
            pref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    try {
                        ((BaseSettingsDialogActivity) getActivity())
